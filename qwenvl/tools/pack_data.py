...
if __name__ == '__main__':
  ...
  argparser.add_argument('--pack_length', type=int, default=8192, help='Length of the packed data')
  argparser.add_argument('--batch_size', type=int, default=256, help='Batch size for processing')
