...
# sbatch qwenvl/scripts/predict.sh --dataset_use surgeryvid_small --sys_prompt default --usr_prompt default --model_name_or_path Qwen2.5-VL-3B-Instruct-openbiomedvid_qa_sys_default
sbatch qwenvl/scripts/predict.sh --dataset_use surgeryvid_small --sys_prompt default,surgeryvid --usr_prompt default --model_name_or_path Qwen2.5-VL-3B-Instruct-openbiomedvid_qa_sys_default
sbatch qwenvl/scripts/predict.sh --dataset_use surgeryvid_small --sys_prompt default --usr_prompt default --model_name_or_path Qwen2.5-VL-3B-Instruct-openbiomedvid_qa_sys_default_surgeryvid
sbatch qwenvl/scripts/predict.sh --dataset_use surgeryvid_small --sys_prompt default,surgeryvid --usr_prompt default --model_name_or_path Qwen2.5-VL-3B-Instruct-openbiomedvid_qa_sys_default_surgeryvid
...
# bash qwenvl/scripts/predict.sh --dataset_use surgeryvid_small --sys_prompt default,surgeryvid --usr_prompt default --model_name_or_path Qwen/Qwen2.5-VL-3B-Instruct &
